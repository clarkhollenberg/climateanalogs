...
noAnalogSum<-merge(noAnalogSum, LUT_plus, by='ECO_ID', all=T)
...
colnames(biomeArea.df)<-c("Area_now", "Area_2C", "Area_4C")
biomeArea.df<-rbind(biomeArea.df, sum(biomeArea.df))
...
biomeTest.df<-biomeArea.df
biomeTest.df$tot_2C<-biomeTest.df$Area_2C+biomeTest.df$noAnalog_2C
biomeTest.df$tot_4C<-biomeTest.df$Area_4C+biomeTest.df$noAnalog_4C
biomeTest.df$diff_2C<-biomeTest.df$tot_2C - biomeTest.df$Area_now
biomeTest.df$diff_4C<-biomeTest.df$tot_4C - biomeTest.df$Area_now
biomeTest.df$base_diff_2C<-biomeTest.df$Area_2C - biomeTest.df$Area_now
biomeTest.df$base_diff_4C<-biomeTest.df$Area_4C - biomeTest.df$Area_now
write.csv(biomeTest.df, "Outputs/Biome_area_changes.csv", row.names = F)
